...
import com.samuel.sniffers.service.metrics.MetricService;
...
@io.swagger.v3.oas.annotations.tags.Tag(name = "metrics", description = "Retrieves Customer-specific metrics.")
